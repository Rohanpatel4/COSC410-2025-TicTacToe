...
def _check_winner(board: list[Cell]) -> Player | None:
    for a, b, c in WIN_LINES:
        if board[a] is not None and board[a] != "-" and board[a] == board[b] == board[c]:
            return board[a]
    return None
...
# Remove part where it track current player
# need to add who made the move function to both the engine and router
# take out starting player from schemas
